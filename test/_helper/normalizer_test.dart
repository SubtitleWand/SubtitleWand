...
class TestNormalizer {
  ...
  static void nearEqualColor(
    ...
    // ''');
    expect(
      nearEqual(actual.red.toDouble(), expected.red.toDouble(), offset),
      isTrue,
    );
    expect(
      nearEqual(actual.green.toDouble(), expected.green.toDouble(), offset),
      isTrue,
    );
    expect(
      nearEqual(actual.blue.toDouble(), expected.blue.toDouble(), offset),
      isTrue,
    );
  }
}
